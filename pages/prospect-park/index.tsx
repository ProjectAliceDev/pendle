...
import previewPageImage from '../../assets/hero/hero.jpg'
import previewPageDevice from '../../assets/devices.jpg'
import previewPageDesign from '../../assets/features/perms.png'
import previewPageDesktop from '../../assets/features/desktop.png'
import previewPageInventories from '../../assets/features/inventories.png'
import previewPageScreenkit from '../../assets/features/screenkit.png'
import previewPageSetup from '../../assets/features/setup-assistant.png'
import previewPageUpdate from '../../assets/features/update.png'


const PreviewPage: NextPage = () => {
  return (
    <Layout title="Prospect Park">
      <MiniNavbar
        title="Prospect Park"
        buttonText="Upgrade"
        buttonLink="../download"
        transparent
      >
        <a href="https://docs.aliceos.app">View the docs</a>
      </MiniNavbar>
